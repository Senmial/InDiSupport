...
const Footer = () => {
    ...
    return (
<footer className="bg-[#380445] relative mt-5 ">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-[#FFFFFF] dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="#" className="hover:underline font-thin">Partners</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-[#FFFFFF] dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="#" className="hover:underline font-thin">YouTube</a>
                      </li>
                  </ul>
              </div>
              <div>
                  ...
                  <ul className="text-[#FFFFFF] dark:text-gray-400 font-medium">
                      ...
                      <li>
                          <a href="#" className="hover:underline font-thin">Terms &amp; Conditions</a>
                      </li>
                  </ul>
              </div>
          </div>
