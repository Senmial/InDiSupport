...
const Login = () => {
  ...
  return (
    <div className="flex  ">
      ...
      <div className="max-h-screen overflow-hidden backdrop-blur-lg">
        ...
        <div className="flex flex-col justify-center items-center">
          ...
          <form action="login" className="w-3/4 py-3 bg-inherit ">
            <div className=" border  border-[#41788E]  rounded-md py-3 px-4 items-center  overflow-hidden flex gap-3">
              ...
              {/* <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -1000 1000 1000" width="24px" fill="#380445"><path d="M192-212q-26 0-43-17t-17-43v-416q0-26 17-43t43-17h576q26 0 43 17t17 43v416q0 26-17 43t-43 17H192Zm288-274L160-698v426q0 14 9 23t23 9h576q14 0 23-9t9-23v-426L480-486Zm0-34 304-200H176l304 200ZM160-698v-22 448q0 14 9 23t23 9h-32v-458Z"/></svg> */}
                
                <input
                  type="text"
                  required
                  placeholder="Email"
                  className="outline-none w-screen   font-thin text-[0.9rem] text-[#380445] bg-inherit"
                />
              </div>
            </div>
            {/* Password Input */}
          ...
          <div className="text-sm font-thin text-[#380445] dark:text-gray-300 ">
            Not registered?{" "}
            <a
              href="#"
              className="text-sm t text-[#F7A741] hover:text-[#41788E] dark:text-blue-500" onClick={() => goTo("/signup")}
            >
              Create account
            </a>
          </div>
          ...
          <button
            type="submit"
            className="rounded-full bg-[#F7A741] w-4/12 flex justify-center mt-5 mb-12 text-[1rem] text-[#FFFFFF] py-3 hover:bg-[#380445] focus:ring-2 focus:ring-[#380445]"
